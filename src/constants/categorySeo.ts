...
export const CATEGORY_COPY: Record<string, CategoryCopy> = {
  'corner-sofa': {
    ...
    body: [
      ...
      'Every corner sofa is delivered free to a UK Mainland address, most within 2 to 4 working days, brought to the ground floor or a ground-floor room of your choice, and paid for in cash or by bank transfer on the doorstep. Nothing upfront. It carries a 1-year guarantee on the frame and springs.',
    ],
  },
  ...
  'fabric-sofa': {
    ...
    description:
      'Fabric sofas made to order in your choice of 69 colours across chenille, velvet and more. Free UK Mainland delivery, most orders in 2-4 working days, paid on arrival.',
    ...
    body: [
      ...
      'Delivery is free to UK Mainland, most orders inside 2 to 4 working days, and you pay cash or by bank transfer when it arrives. Fabric needs a little care to stay looking new; the [care guide](/care-guide) covers the first thirty seconds of a spill, which is the part that decides the outcome.',
    ],
  },
  ...
  'leather-sofa': {
    ...
    description:
      'Leather sofas and 3+2 leather sofa sets that wipe clean in seconds. Free UK Mainland delivery, most orders in 2-4 working days, paid when it arrives.',
    ...
    body: [
      ...
      'Leather sofas here are stocked in set sizes rather than made to order, so they ship sooner and, being a standard size, they come with the full 14-day right to change your mind. Delivery is free across UK Mainland, most orders inside 2 to 4 working days, cash or bank transfer on the doorstep, with a 1-year guarantee on the frame and springs. Check the doorway first with the [size guide](/size-guide): a leather three-seater does not give under pressure the way a fabric one does.',
    ],
  },
  ...
  'electric-sofa': {
    ...
    description:
      'Electric recliner sofas and power reclining sofa sets, reclining at the touch of a button. Free UK Mainland delivery, most orders in 2-4 working days, cash on delivery.',
  ...
  '3-2-seater': {
    ...
    description:
      'A three seater and a two seater together - the usual answer for a family living room. Free UK Mainland delivery, most orders in 2-4 working days, cash on delivery.',
  ...
  all: {
    ...
    body: [
      ...
      'However you get there: free delivery to any UK Mainland address, most orders inside 2 to 4 working days, brought to the ground floor or a ground-floor room of your choice, and paid for in cash or by bank transfer when it arrives rather than upfront. A 1-year guarantee covers the frame and springs. You can also see everything in person at the Blackburn [showroom](/showroom), by appointment.',
    ],
  },
}

...
export const CATEGORY_COPY: Record<string, CategoryCopy> = {
  ...
  'leather-sofa': {
    ...
    body: [
      ...
      'Worth being precise about what "leather" means here, because the trade is often not. The Nova range is upholstered in tech leather - a breathable, scratch-resistant coated material that wipes clean - and the Roma range in a blend of leather and soft fabric. Neither behaves like full hide: they hold their finish and their colour rather than developing the patina an expensive hide sofa is bought for. If genuine hide specifically is what you are after, ask us before ordering.',

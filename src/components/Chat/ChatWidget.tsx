...
export default function ChatWidget() {
  ...
  return (
    <>
      {/* The launcher. Stacked above the WhatsApp pill: same edge inset, same
          clearance, one pill-height higher. Ink rather than a second colour
          so the green stays the one thing that means "talk to a person". */}
      <button
        ref={launcher}
        type="button"

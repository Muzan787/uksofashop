    ...
    <form onSubmit={handleSubmit} className="space-y-8 bg-white p-5 lg:p-8 rounded-md shadow-sm border border-stone-200">
      ...
      <div className="space-y-5">
        <div>
          ...
          <input type="text" name="title" required className="w-full p-3.5 bg-stone-50 border border-stone-200 rounded-sm focus:ring-2 focus:ring-orange-500 outline-none font-medium" placeholder="e.g. The Cloud Sofa" />
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <div>
            ...
            <select name="origin" defaultValue="unspecified" className="w-full p-3.5 bg-stone-50 border border-stone-200 rounded-sm focus:ring-2 focus:ring-orange-500 outline-none font-medium">
        ...
        <div>
          ...
          <textarea name="description" rows={4} required className="w-full p-3.5 bg-stone-50 border border-stone-200 rounded-sm focus:ring-2 focus:ring-orange-500 outline-none font-medium"></textarea>
        </div>
      </div>

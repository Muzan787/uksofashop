 ...
 *
 * POSITION. Bottom LEFT. The bottom-right corner belongs to the product
 * page's floating "Add to cart" pill (components/Product/AddToCartFab.tsx),
 * which is this button's mirror image: ask on the left, buy on the right. It
 * is the left corner on every page, not only where that pill exists, because
 * a button that changes corners between pages has to be found again on each
 * one. `.fab-offset` (globals.css) clears the bottom navigation and the
 ...
 * covering bar on top of that - for this button, for the assistant's "Ask us"
 * pill stacked above it, and for the add-to-cart pill opposite.
 *
...
export default function WhatsAppFab() {
  ...
  return (
    <a
      ...
      className="hover-btn btn-whatsapp shadow-whatsapp fab-offset fixed left-4 z-sticky-bar flex h-12 items-center gap-2 rounded-pill bg-whatsapp px-4 text-ink-900 no-underline transition-[bottom] duration-base ease-out-expo focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ink-900"
    >
